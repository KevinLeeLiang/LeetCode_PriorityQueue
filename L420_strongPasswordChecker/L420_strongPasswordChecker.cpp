...
/**
  ******************************************************************************
  * @file           : L420_strongPasswordChecker.cpp.cc
  * @author         : garen_lee
  * @brief          : None
  * @attention      : None
  * @date           : 2025/3/7
...
#include "L420_strongPasswordChecker.h"

int L420_strongPasswordChecker::strongPasswordChecker(string password) {
    int n = password.size();
...
void L420_strongPasswordChecker::test() {
    string password = "a";
