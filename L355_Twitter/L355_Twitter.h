...
#ifndef PRIORITYQUEUE_L355_TWITTER_H
#define PRIORITYQUEUE_L355_TWITTER_H
...
class L355_Twitter : public LeetcodePriorityQueue{
public:
    L355_Twitter() {}
    void test();
private:
    L355::Twitter twitter_;
};


#endif //PRIORITYQUEUE_L355_TWITTER_H
